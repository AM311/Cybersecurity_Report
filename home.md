...
In this guide, many details will be omitted since the configuration of an OS is not the main goal of this document; it will be just given an outline of the main settings that are needed for each machine and the ways to achieve them.
...
hhhh
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MDc1ODcxNTAsMTYyMzExMzU5MSw3ND
